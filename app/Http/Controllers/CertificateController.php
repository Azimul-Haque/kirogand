...
class CertificateController extends Controller
{
    ...
    public function storeCertificate(Request $request, $certificate_type)
    {
        ...
        } elseif($certificate_type == 'citizen-certificate' || $certificate_type == 'permanent-resident' || $certificate_type == 'same-person') {
            $validatedData = $request->validate([
                'name' => ['required', 'string', 'max:255'],
                'father' => ['required', 'string', 'max:255'],
                'mother' => ['required', 'string', 'max:255'],
        ...
        } elseif($certificate_type == 'citizen-certificate' || $certificate_type == 'permanent-resident') {
            $dataPayload = [
                'applicant' => $applicantData,
                'submission_timestamp' => now()->toDateTimeString(),
            ];
