...
class DashboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['admin_or_manager'])->only('getApplyforCertificate', 'getProfile', 'updateProfileUser', 'updateProfileLocalOffice', 'getLocalOfficeUsers', 'getLocalOfficeUsersCerts');
    }
    ...
    {
        $user = User::find($id);
        return view('dashboard.localoffices.certificates')->withUser($user);
    }
