...
@php
    ...
    $route = $isEdit
        ...
        : route('dashboard.certificates.store', 'death-certificate');
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control @error('death_date') is-invalid @enderror" id="death_date" name="death_date"
                           value="{{ old('death_date', $applicant['death_date'] ?? date('Y-m-d')) }}" value="{{  }}" max="{{ date('Y-m-d') }}" placeholder="মৃত্যুর তারিখ" data-date="" data-date-format="DD MMMM YYYY" required>
