...
<script type="text/template" id="sub-heir-row-template">
    <tr class="sub-heir-row">
        ...
        <td>
            <input type="text" class="form-control form-control-sm" name="heirs_data[__PARENT_INDEX__][sub_heirs][__SUB_INDEX__][remark]" placeholder="যেমন: নাবালক" data-toggle="tooltip" data-original-title="ওয়ারিশ মৃত হলে সাব-ওয়ারিশ যোগ করুন" title="ওয়ারিশ মৃত হলে সাব-ওয়ারিশ যোগ করুন">
        </td>
        <td>
