        ...
        <div class="card-body">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-prepend">
                            <select class="custom-select @error('id_type') is-invalid @enderror" id="id_type" name="id_type" required style="width: 110px;">
                                <option value="এনআইডি" {{ old('id_type') == 'এনআইডি' ? 'selected' : '' }}>এনআইডি</option>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('father') is-invalid @enderror" id="father" name="father" value="{{ old('father') }}" placeholder="পিতার নাম" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('mother') is-invalid @enderror" id="mother" name="mother" value="{{ old('mother') }}" placeholder="মাতার নাম" required>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="number" class="form-control @error('ward') is-invalid @enderror" id="ward" name="ward" value="{{ old('ward') }}" placeholder="ওয়ার্ড (যেমন ৪নং ভবানন্দপুর)" required>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control @error('union') is-invalid @enderror" id="union" name="union" value="{{ Auth::user()->localOffice->name_bn }}" required>
