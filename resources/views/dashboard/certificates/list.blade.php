                      ...
                      @forelse ($certificates as $certificate)
                          <tr>
                              ...
                              <td>
                                ...
                                @if ($certificate->status == 1)
                                    <a href="{{ route('dashboard.certificates.edit', $certificate->unique_serial) }}" id="pulseThis{{ $certificate->unique_serial }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="প্রিন্ট করুন">
