    ...
    <div>
        ...
        <table style="width: 100%; margin-top: 5px;">
            <tr>
                ...
                <td style="text-align: right; font-size: 14px;">ইস্যুর তারিখ : {{ $certificate->issued_at != null ?  bangla(date('d-m-Y', strtotime($certificate->issued_at))) : {{ bangla(date('d-m-Y')) ?? '--' }} }}</td>
            </tr>
            <tr>
