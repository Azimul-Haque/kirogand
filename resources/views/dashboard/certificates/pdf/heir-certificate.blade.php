    ...
    <table class="header-table">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <span style="font-size: 16px; line-height: 2.5;">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</span><br/>
                <span style="font-size: 18px; font-weight: bold; color: #15803D; line-height: 2.5;">{{ $union_info['union_name'] }}</span><br/>
    ...
    <div>
        ...
        <table style="width: 100%; margin-top: 5px;">
            <tr>
                ...
                <td style="text-align: right; font-size: 14px;">ইস্যুর তারিখ : {{ $certificate->issued_at != null ?  bangla(date('d-m-Y', strtotime($certificate->issued_at))) : '--' }}</td>
            </tr>
            <tr>
        ...
        <table class="signature-block">
            <tr>
                <td>
                    <img src="{{ public_path('images/govt-logo.png') }}" style="height: 70px; width: auto; display: block; margin: 0 auto;">
                </td>
                <td>
