    ...
    <table class="header-table">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <p style="font-size: 16px; line-height: 1.0;">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</p><br/>
                <p style="font-size: 18px; font-weight: bold; color: #15803D; line-height: 1.0;">{{ $union_info['union_name'] }}</p><br/>
