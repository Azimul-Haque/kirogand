                                    ...
                                    <div class="col-md-6">
                                      <div class="input-group mb-3">
                                          ...
                                          <select id="designation" name="designation" class="form-control">
                                              ...
                                              <option value="সচিব" @if($user->designation == 'চেয়ারম্যান') selected @endif>ইউনিয়ন সচিব</option>
                                              <option value="সহকারী" @if($user->designation == 'চেয়ারম্যান') selected @endif>ইউনিয়ন সহকারী</option>
                                              <option value="মেয়র" @if($user->designation == 'চেয়ারম্যান') selected @endif>মেয়র</option>
                                              <option value="কাউন্সিলর" @if($user->designation == 'চেয়ারম্যান') selected @endif>কাউন্সিলর</option>
                                              <option value="পৌর সচিব" @if($user->designation == 'চেয়ারম্যান') selected @endif>পৌর সচিব</option>
                                          </select>
                                          <div class="input-group-append">
                                              <div class="input-group-text"><span class="fas fa-user-secret"></span></div>
                                          </div>
