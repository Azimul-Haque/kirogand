...
@section('content')
  ...
  @endsection
    <div class="container-fluid">
        ...
        <div class="col-md-6 col-lg-4 mb-5">
            <div class="card h-100 video-card shadow-lg">
                <div class="thumbnail-container" data-toggle="modal" data-target="#videoModal" data-youtube-id="XtAT9CDQg">
                    <img src="https://img.youtube.com/vi/XtAT9CDQg/hqdefault.jpg" alt="প্যাকেজ নবায়ন থাম্বনেইল">
                    <div class="play-overlay">
                        <i class="fab fa-youtube"></i>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-watch btn-block mt-auto" 
                            data-toggle="modal" data-target="#videoModal" data-youtube-id="XtAT9CDQg">
                        <i class="fas fa-video mr-2"></i> ভিডিও দেখুন
                    </button>
                </div>
            </div>
