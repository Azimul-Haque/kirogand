        ...
        <div class="col-md-6 col-lg-4 mb-5">
            <div class="card h-100 video-card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">ডি-নাগরিক ড্যাশবোর্ডে ওয়ারিশ বা উত্তরাধিকার সনদ তৈরির প্রয়োজনীয় সব ধাপ এই ভিডিওতে দেখুন।</p>
                    <button type="button" class="btn btn-watch btn-block mt-auto" 
        ...
        <div class="col-md-6 col-lg-4 mb-5">
            <div class="card h-100 video-card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">ডি-নাগরিক প্ল্যাটফর্ম থেকে ইস্যু হওয়া যেকোনো ডিজিটাল সনদপত্র (যেমন: ওয়ারিশ সনদ, নাগরিকত্ব সনদ, চারিত্রিক সনদ ইত্যাদি) আসল নাকি নকল, তা যাচাই করা অত্যন্ত জরুরি। এই ভিডিওতে আমরা ধাপে ধাপে দেখিয়েছি কীভাবে ডি-নাগরিক ওয়েবসাইটে গিয়ে খুব সহজে যেকোনো সনদের বৈধতা যাচাই (Verification) করা যায়।</p>
                    <button type="button" class="btn btn-watch btn-block mt-auto" 
                            data-toggle="modal" data-target="#videoModal" data-youtube-id="5CZfxVfwBec">
                        <i class="fas fa-video mr-2"></i> ভিডিও দেখুন
                    </button>
