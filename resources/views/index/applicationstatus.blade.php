...
@section('title') ডিজিটাল নাগরিক - আবেদনের অবস্থা @endsection
...
@section('content')
  ...
  <section id="services" class="service-section section-gap">
    <div class="container">
      <h1 class="text-center display-6 fw-bold mb-5" style="color: var(--darker-color);"><i class="fas fa-check-circle me-3 text-success"></i> আবেদনের অবস্থা যাচাই</h1>
