        ...
        <div class="accordion" id="faqAccordion">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        ডি-নাগরিক সরাসরি ডিজিটাল প্ল্যাটফর্ম থেকে সেবা প্রদান করে, ফলে মধ্যস্থতাকারীর প্রয়োজন হয় না। এতে দুর্নীতি ও অবৈধ লেনদেন কমে যায় এবং স্বচ্ছতা নিশ্চিত হয়। এছাড়া, QR কোড ও সনদ আইডি দিয়ে সনদ যাচাই করা যায়, ফলে জাল সনদ তৈরি করার সুযোগ রোধ সম্ভব।
                    </div>
                </div>
            </div>
