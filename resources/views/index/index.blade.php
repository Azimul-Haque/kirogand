          ...
          <div class="row align-items-center">
              <div class="col-lg-6 mb-4 mb-lg-0 hero-text">
                  ...
                  <div class="mt-4 d-flex flex-column flex-md-row">
                      ...
                      <a href="{{ route('index.verify-certificate') }}" class="btn btn-outline-secondary btn-lg rounded-pill shadow" style="border-color: var(--darker-color); color: var(--darker-color);">
