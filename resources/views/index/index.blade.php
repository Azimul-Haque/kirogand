          ...
          <div class="row align-items-center">
              <div class="col-lg-6 mb-4 mb-lg-0 hero-text">
                  ...
                  <p class="lead text-muted mt-3">
                    দ্রুত, নির্ভরযোগ্য এবং শতভাগ যাচাইযোগ্য **ডিজিটাল সনদপত্র** (জন্ম, মৃত্যু, চারিত্রিক, নাগরিকত্ব) স্থানীয় কর্তৃপক্ষ থেকে গ্রহণ করুন। আপনার প্রয়োজন, এখন ডিজিটাল উপায়ে আপনার হাতের মুঠোয়।
