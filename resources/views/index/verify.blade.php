                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-5 text-center">
                          <span for="verificationInput" class="fw-bold h4">
                            <i class="@if(isset($certificate)) fas @if($certificate->status == 1) fa-check-circle me-3 text-success @else fa-check-circle me-3 text-warning @endif fas fa-info @else fas fa-times-circle me-3 text-danger @endif"></i>
