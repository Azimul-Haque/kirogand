                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-5 text-center">
                          <span for="verificationInput" class="fw-bold h4">
                            <i class="@if(isset($certificate)) fas @if($certificate->status == 1) fa-check-circle me-3 text-success @else fa-check-circle me-3 text-success @endif  @else fas fa-times-circle me-3 text-danger @endif"></i>
                            @if(isset($certificate))
                              <span class="text-success">সনদটি @if($certificate->status == 1) বৈধ! @else প্রক্রিয়াধীন @endif</span>
                            @else
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <ul class="list-group list-group-flush border rounded-lg mb-4">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 bg-light">
                                ...
                                <span id="statusDisplay" class="badge @if($certificate->status == 1) bg-success @else bg-danger  @endif text-white px-3 py-2 rounded-pill text-bn">
                                  {{ $certificate->status == 1 ?  'সক্রিয় (Verified)' : 'স্থগিত (Suspended)' }}
                                </span>
                            </li>
                        </ul>
