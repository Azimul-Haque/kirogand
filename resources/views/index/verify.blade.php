...
@section('content')
  ...
  <section id="services" class="service-section section-gap">
    <div class="container">
      <h1 class="text-center display-6 fw-bold mb-5" style="color: var(--darker-color);"><i class="@if(isset($certificate)) text-success @else text-danger @endif"></i> সনদপত্র যাচাই ফলাফল</h1>
