      ...
      <div class="row justify-content-center">
          ...
          <div class="col-md-8 col-lg-6"> 
              ...
              <div class="card p-4 p-md-5 shadow-lg rounded-3">
                  <div class="card-body">
                      <p class="lead text-muted mb-4 text-center">সনদটি যাচাই করতে অনুগ্রহ করে 'সনদ নং' অথবা 'আবেদন আইডি নং'-এর যেকোনো একটি সঠিকভাবে পূরণ করুন অথবা QR কোডটি স্ক্যান করুন</p>
