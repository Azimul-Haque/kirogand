...
<div class="row">
    ...
    <section class="col-lg-5 connectedSortable">
        ...
        <div class="card @if(isPackageExpired(Auth::user()->localOffice->package_expiry_date)) bg-danger @elseif(isPackageExpiringSoon(Auth::user()->localOffice->package_expiry_date)) bg-warning @else bg-success @endif shadow">
