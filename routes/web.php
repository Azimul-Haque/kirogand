...
Route::get('/dashboard/localoffice/users/{search}', 'DashboardController@getLocalOfficeUsersSearch')->name('dashboard.localoffice.users.search');
Route::get('/dashboard/localoffice/users/{id}/certificates', 'DashboardController@getLocalOfficeUsersCerts')->name('dashboard.localoffice.users.certificates');
...
Route::get('/dashboard/video-tutorials', 'DashboardController@getVideoTutorial')->name('dashboard.video.tutorials');
...
Route::get('/dashboard/certificates-list/{search}', 'CertificateController@getCertificateListSearch')->name('dashboard.certificates.list.search');
// Certificate routes are here
// Certificate routes are here
// Certificate routes are here
