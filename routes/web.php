...
Route::get('/verify', 'IndexController@getVerifyCertificate')->name('index.verify-certificate');
Route::get('/status', 'IndexController@getApplicationStatus')->name('index.application-status');
...
Route::get('/dashboard/certificates/create/{certificate_type}', 'CertificateController@getApplicationbyCType')->name('dashboard.certificates.certificate_type');
Route::get('/dashboard/certificates/edit/{certificate_type}', 'CertificateController@getApplicationbyCType')->name('dashboard.certificates.certificate_type');
