...
Route::get('/dashboard/certificates/{certificate_type}', 'CertificateController@getApplicationbyCType')->name('dashboard.certificates.certificate_type');
Route::get('/dashboard/certificates/draft/{certificate_type}', 'CertificateController@getApplicationbyCType')->name('dashboard.certificates.certificate_type');
